...
Target.create "Lib_Build" (fun _ ->
    buildSource "Be.Vlaanderen.Basisregisters.AspNetCore.Mvc.ModelBinding.GuidHeader"
)

Target.create "Lib_Publish" (fun _ -> publishSource "Be.Vlaanderen.Basisregisters.AspNetCore.Mvc.ModelBinding.GuidHeader")
